...
process.TrackRefitter1 = process.TrackRefitter.clone(
   src = 'HighPuritySelector',  # can we use this? #'AliMomConstraint1',
   TrajectoryInEvent = True,
   TTRHBuilder = "WithAngleAndTemplate",
   NavigationSchool = ""
)
...
process.offlineBeamSpot*process.AliMomConstraint1*process.HighPuritySelector*process.TrackRefitter1*process.TrackerTrackHitFilter*process.HitFilteredTracks
